!(function (e) {
  ...
  if (
    ...
    t.on("scroll", function () {
      t.scrollTop() > 0
        ? e(".header-area").addClass("sticky")
        : e(".header-area").removeClass("sticky");
    }),
    e.fn.owlCarousel)
  ) {
    ...
    a.owlCarousel({
      ...
      e(".client_slides").owlCarousel({
        responsive: { 0: { items: 1 }, 991: { items: 2 }, 767: { items: 1 } },
        loop: !0,
        autoplay: !0,
        smartSpeed: 700,
        dots: !0,
  ...
  e.fn.magnificPopup &&
    (e("#videobtn").magnificPopup({ type: "iframe" }),
    e(".gallery_img").magnificPopup({
      type: "image",
      gallery: { enabled: !0 },
      removalDelay: 300,
      mainClass: "mfp-fade",
    ...
    e.fn.imagesLoaded &&
      e(".dream-portfolio").imagesLoaded(function () {
        ...
        var t = e(".dream-portfolio").isotope({
    ...
    e(".portfolio-menu button.btn").on("click", function () {
      e(".portfolio-menu button.btn").removeClass("active"),
        e(this).addClass("active");
    }),
    e.fn.scrollUp &&
      e.scrollUp({ scrollSpeed: 1500, scrollText: "Scroll Top" }),
    e.fn.onePageNav &&
      e("#nav").onePageNav({
        currentClass: "active",
        scrollSpeed: 1500,
  ...
  (document.onkeyup = function (e) {
    ...
    (document.onkeydown = function (e) {
      if (
        (17 == e.which && (n = !0), 85 == e.which || (67 == e.which && 1 == n))
      )
        return !1;
    });

  e("#submit-form").on("click", (g) => {
    g.preventDefault();

    const toastMessage = e("#success_fail_info");

    var onSuccess = function (response) {
      toastMessage.text("Sent message successfully!");
    };

    var onError = function (err) {
      toastMessage.text("Error while sending message!");
    };
    ...
    if (data.Email && data.Name && data.Subject && data.Phone && data.Message) {
      toastMessage.text("Loading. Please wait...");
      $.ajax({
        type: "POST",
        url: "https://public.herotofu.com/v1/7aaf05d0-a2be-11ed-a31e-753411848f80",
      ...
      toastMessage.text("Please fill all inputs.");
    }
  });
})(jQuery);
